...
@section('title', 'Powerlifting')

@section('conteudo')

{{-- ÁREA DE SERVIÇO --}}
<div class="breadcumb-wrapper" data-bg-src="{{ asset('img/bg/powerlifting.jpg') }}">
    <!-- bg animated image/ -->
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcumb-content">
                    ...
                    <ul class="breadcumb-menu">
                        ...
                        <li class="active" style="text-transform:uppercase;"><a href="{{ url('/treino/EMOM') }}">@yield('title')</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-xxl-8 col-lg-7">
                <div class="service-page-single">
                    ...
                    <div class="page-content">
                        <h2 class="page-title">Power Lifting</h2>
                        ...
                        <div class="page-img mb-50">
                            <img src="{{ asset('img/bg/levantamento.jpg') }}" alt="img">
                        </div>
