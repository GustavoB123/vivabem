...
@section('conteudo')
 ...
 {{-- ÁREA DE SERVIÇO --}}
 <div class="breadcumb-wrapper" data-bg-src="{{ asset('img/bg/artesmarciais.jpg') }}">
    <!-- bg animated image/ -->
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcumb-content">
                    ...
                    <ul class="breadcumb-menu">
                        ...
                        <li class="active"><a href="{{ url('/treino/EMOM') }}" style="text-transform: uppercase;">@yield('title')</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-xxl-8 col-lg-7">
                <div class="service-page-single">
                    ...
                    <div class="page-content">
                        <h2 class="page-title">Muay Thai</h2>

                        <p class="mb-30">
                            O treinamento EMOM (Every Minute On the Minute) é uma abordagem popular no fitness, onde os
                            participantes executam um exercício específico a cada minuto, buscando completar a tarefa
                            designada o mais rápido possível para aproveitar o tempo restante antes do próximo ciclo.
                            Essa técnica é usada para melhorar a resistência cardiovascular, promover eficiência de
                            tempo, aumentar a intensidade do treino, adaptar-se à fadiga e introduzir variedade nas
                            sessões de exercícios.
                        </p>

                        <p class="mb-50">
                            É importante ajustar a intensidade de acordo com o nível de condicionamento físico
                            individual e considerar a orientação de um profissional para personalizar o treinamento
                            conforme metas específicas.
                        </p>

                        <div class="page-img mb-50">
                            <img src="{{ asset('img/bg/muaythai.png') }}" alt="img">
                        </div>

                        <h2 class="page-title" style="margin-top: 75px">Boxing</h2>
                        ...
                        <div class="page-img mb-50">
                            <img src="{{ asset('img/bg/boxing.png') }}" alt="img">
                        </div>

                        <h2 class="page-title" style="margin-top: 75px;">Capoeira</h2>
                        ...
                        <div class="page-img mb-50">
                            <img src="{{ asset('img/bg/capoeira.png') }}" alt="img">
                        </div>
                ...
                <aside class="sidebar-area">
                    <div class="widget widget_categories">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="/modalidade/artesmarciais"><i class="fa-solid fa-arrow-right"></i>Artes Marciais</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="/modalidade/cardiovascular"><i class="fa-solid fa-arrow-right"></i>Cardiovascular</a>
                            </li>
                            <li>
                                <a href="/modalidade/powerlifting"><i class="fa-solid fa-arrow-right"></i>Power Lifting</a>
                            </li>
                        </ul>
                    </div>
