...
@section('conteudo')
    ...
    {{-- ÁREA DE SERVIÇO --}}
    <div class="breadcumb-wrapper" data-bg-src="{{ asset('img/bg/fundoCardio.jpg') }}">
        <!-- bg animated image/ -->
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                ...
                <div class="col-xxl-8 col-lg-7">
                    <div class="service-page-single">
                        ...
                        <div class="page-content">
                            ...
                            <p class="mb-30">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci laudantium, harum illum
                                deserunt possimus fuga esse unde eligendi reiciendis assumenda. Debitis perferendis
                                repudiandae accusantium voluptas tempore quas, quam quo consectetur Lorem ipsum dolor sit
                                amet consectetur adipisicing elit. Hic eveniet debitis dolore, est non eius fuga atque nemo
                                consequuntur cum nobis earum tenetur ea sequi, incidunt adipisci molestiae ullam suscipit.
                            </p>

                            <p class="mb-50">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos provident ducimus culpa
                                ut. Distinctio, expedita? Animi rem aperiam tenetur. Nisi tenetur qui ullam nesciunt
                                dolorum! Mollitia voluptatem vero impedit blanditiis.
                            </p>

                            <div class="page-img mb-50">
                                <img src="{{ asset('img/bg/imgCardio.jpg') }}" alt="img">
                            </div>
