                ...
                <div class="col-lg-12">
                    <div class="breadcumb-content">
                        ...
                        <ul class="breadcumb-menu">
                            ...
                            <li class="active"><a href="{{ url('/treino/hiit') }}" style="text-transform: uppercase;">@yield('title')</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xxl-8 col-lg-7">
                    <div class="service-page-single">
                        ...
                        <div class="page-content">
                            <h2 class="page-title">HIIT (High-Intensity Interval Training)</h2>
                            <p class="mb-30">
                                O Treinamento Intervalado de Alta Intensidade, conhecido como HIIT
                                (High-Intensity Interval Training), é uma forma de exercício que alterna entre períodos de
                                esforço intenso e curtos períodos de recuperação ou descanso. O HIIT é conhecido por ser um
                                método eficaz para queimar calorias, melhorar o condicionamento cardiovascular e promover
                                ganhos de resistência em um curto período de tempo.
                            </p>

                            <p class="mb-50">
                                Lembre-se de ajustar a intensidade e a duração com base no seu nível de condicionamento
                                físico e objetivos específicos. Antes de iniciar qualquer novo programa de treinamento, é
                                aconselhável consultar um profissional de saúde ou um educador físico.
                            </p>
                            ...
                            <div class="service-page-list checklist mb-50"
                                ...
                                <ul>
                                    ...
                                    <li><i class="far fa-check-circle"></i>Ajustar a ingestão de calorias conforme necessário.</li>
                                </ul>
                            </div>
