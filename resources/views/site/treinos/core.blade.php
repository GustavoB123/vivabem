                ...
                <div class="col-lg-12">
                    <div class="breadcumb-content">
                        ...
                        <ul class="breadcumb-menu">
                            ...
                            <li class="active"><a href="{{ url('/treino/core') }}" style="text-transform: uppercase;">@yield('title')</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xxl-8 col-lg-7">
                    <div class="service-page-single">
                        ...
                        <div class="page-content">
                            <h2 class="page-title">Core</h2>
                            <p class="mb-30">
                                O treinamento do core refere-se a exercícios e práticas que visam fortalecer os músculos do
                                tronco, que compreendem a região abdominal, lombar, pelve e quadris. Esses músculos formam o
                                centro do corpo e desempenham um papel fundamental na estabilização e suporte durante uma
                                variedade de movimentos. O termo "core" em inglês significa "núcleo" ou "centro".
                            </p>

                            <p class="mb-50">
                                O core é composto por diversos músculos, incluindo os músculos abdominais (como os oblíquos
                                e o reto abdominal), os músculos da região lombar, os músculos da pelve e os músculos
                                profundos da região abdominal, como o transverso do abdome.
                            </p>
