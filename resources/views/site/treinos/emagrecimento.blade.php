                ...
                <div class="col-lg-12">
                    <div class="breadcumb-content">
                        ...
                        <ul class="breadcumb-menu">
                            ...
                            <li class="active"><a href="{{ url('/treino/emagrecimento') }}" style="text-transform: uppercase;">@yield('title')</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xxl-8 col-lg-7">
                    <div class="service-page-single">
                        ...
                        <div class="page-content">
                            <h2 class="page-title">Treinamento para o emagrecimento</h2>
                            <p class="mb-30">
                                O termo "treinamento de emagrecimento" refere-se a um programa de exercícios físicos
                                projetado especificamente para ajudar as pessoas a perderem peso. Esses programas geralmente
                                combinam atividades aeróbicas, treinamento de resistência e, em alguns casos, exercícios de
                                flexibilidade. O objetivo principal é criar um déficit calórico, onde o corpo queima mais
                                calorias do que consome, levando à perda de peso.
                            </p>

                            <p class="mb-50">
                                Um treinamento de emagrecimento eficaz pode incluir uma variedade de atividades, como
                                corrida, caminhada, ciclismo, natação e treinamento de força. Além do exercício físico, a
                                dieta desempenha um papel crucial no processo de emagrecimento. Muitas vezes, programas de
                                treinamento de emagrecimento são combinados com orientação nutricional para otimizar os
                                resultados.
                            </p>
